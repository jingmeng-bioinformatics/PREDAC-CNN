...
class str_to_num():
    ...
    def generate_seq(self, seq1, seq2 ,clas):
        ...
        if seq1 and seq2:
            for i in range(len(seq1)):
                ...
                one_char = [-1]*15
                if seq1[i] in aj_dic:
                    one_char[0] = aj_dic[seq2[i]]['num'] / 20
                    one_char[1] = aj_dic[seq2[i]]['access']
                    one_char[2] = aj_dic[seq2[i]]['charge']
                    one_char[3] = aj_dic[seq2[i]]['hydro']
                    one_char[4] = aj_dic[seq2[i]]['hyindex']
                    one_char[5] = aj_dic[seq2[i]]['polar']
                    one_char[6] = aj_dic[seq2[i]]['volume']
                    
                if seq2[i] in aj_dic:
                    one_char[7] = aj_dic[seq1[i]]['num'] / 20
                    one_char[8] = aj_dic[seq1[i]]['access']
                    one_char[9] = aj_dic[seq1[i]]['charge']
                    one_char[10] = aj_dic[seq1[i]]['hydro']
                    one_char[11] = aj_dic[seq1[i]]['hyindex']
                    one_char[12] = aj_dic[seq1[i]]['polar']
                    one_char[13] = aj_dic[seq1[i]]['volume']
                one_char[14] = clas
                one_seq.append(one_char)   
        else:
    ...
    def save_to_npy(self,filename):
        ...
        np.save('./npy_double/'+filename+'.npy', arr)
